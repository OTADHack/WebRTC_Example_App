...
(function () {
  ...
  var defaultConfiguration = {
    ...
    toolName: "TADHack collaboration Tool",
    ...
    inviteFromRoom: "RoomTADHackOptare",
    ...
    disableWebRTC: false,
    // When true, the WebRTC-based video will be disabled
    disableVideoRTC: false,
  ...
  TogetherJS._defaultConfiguration = {
    ...
    // A function that will return the name of the user:
    getUserName: null,
    //getUserName: function () {return TogetherJS.require("peers").Self.name;},
	//getUserName: function () {return "mpenas";},
	// A function that will return the color of the user:
    getUserColor: null,
    // A function that will return the avatar of the user:
    getUserAvatar: null,
