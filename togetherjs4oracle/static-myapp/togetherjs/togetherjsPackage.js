...
define('webrtc',["require", "jquery", "util", "session", "ui", "peers", "storage", "windowing"], function (require, $, util, session, ui, peers, storage, windowing) {
  ...
  session.on("ui-ready", function () {
    ...
    function error() {
      ...
      //TODO: this title doesn't seem to display?
    ...
    function connect() {
      ...
      if (! (offerSent || offerReceived)) {
        ...
        //TODO: I might have only needed this due to my own bugs, this might
    ...
    function toggleMute() {
      //TODO: implement.  Actually, wait for this to be implementable - currently
      // muting of localStreams isn't possible
      //TODO: replace with hang-up?
    }
    ...
    session.hub.on("rtc-answer", function (msg) {
      ...
      connection.setRemoteDescription(
        ...
        function () {
          ...
          //TODO: I don't think this connect is ever needed?
          connect();
        },
        function (err) {
          error("Error doing RTC setRemoteDescription:", err);
    ...
    session.hub.on("hello", function (msg) {
      //TODO: displayToggle should be set due to
